...
<body>
    ...
    <div class="container">
        ...
        <form action="check.php" method="post" enctype="multipart/form-data" class="inputblock">
            <input type="text" placeholder="Логин" class="textarea" value="<?= $login ?>" name="login" id="login" />
            <input type="text" placeholder="Имя" class="textarea" value="<?= $name ?>" name="name" id="name" />
